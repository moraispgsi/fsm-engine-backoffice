  ...
  module.exports = merge(common, siteCommon, {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        template: 'lib/index_template.ejs', // eslint-disable-line global-require
        inject: true,
        mobile: true,
        title: pkg.name,
        appMountId: 'app',
  ...
  module.exports = merge(common, siteCommon, {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([
        ...
        { from: 'public/bower_components', to: 'public/bower_components' },
        { from: 'public/dist', to: 'public/dist' },
        { from: 'public/plugins', to: 'public/plugins' },
      ]),
      new HtmlWebpackPlugin({
